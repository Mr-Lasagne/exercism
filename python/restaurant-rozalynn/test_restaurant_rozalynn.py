...
import pytest
from restaurant_rozalynn import (
...
class TestRestaurantRozalynn(unittest.TestCase):
    ...
    def test_arrange_reservations_1(self):
        ...
        self.assertDictEqual(
            arrange_reservations(guests), expected_results, msg=failure_msg
        )
    ...
    def test_find_all_available_seats_1(self):
        ...
        self.assertListEqual(
            find_all_available_seats(seats), expected_results, msg=failure_msg
        )
    ...
    def test_find_all_available_seats_2(self):
        ...
        self.assertListEqual(
            find_all_available_seats(seats), expected_results, failure_msg
        )
    ...
    def test_accommodate_waiting_guests_1(self):
        ...
        self.assertDictEqual(
            accommodate_waiting_guests(reservations, guests),
            reservations,
            msg=failure_msg,
        )
    ...
    def test_empty_seats_1(self):
        ...
        self.assertDictEqual(
            empty_seats(seats, seat_numbers), expected_results, msg=failure_msg
        )
