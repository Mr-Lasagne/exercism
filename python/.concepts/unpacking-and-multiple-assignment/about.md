# Unpacking and Multiple Assignment <!-- omit in toc -->
...
If both **keys** and **values** are needed, use the `items()` method. Using
...
You can also write parameters before `*args` to allow for specific positional
