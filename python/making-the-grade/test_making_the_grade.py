...
class TestMakingTheGrade(unittest.TestCase):
    ...
    def test_count_failed_students(self):
        test_data = [
            [89, 85, 42, 57, 90, 100, 95, 48, 70, 96],
    ...
    def test_letter_grades(self):
        ...
        for variant, (highest, expected) in enumerate(
            ...
            with self.subTest(
                f"variation #{variant}", highest=highest, expected=expected
            ):
    ...
    def test_perfect_score(self):
        ...
        for variant, (student_info, expected) in enumerate(
            ...
            with self.subTest(
                f"variation #{variant}", student_info=student_info, expected=expected
            ):
