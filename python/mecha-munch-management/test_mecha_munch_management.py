...
import pytest
from mecha_munch_management import (
    add_item,
    read_notes,
    send_to_store,
    sort_entries,
...
class TestMechaMunchManagement(unittest.TestCase):
    ...
    def test_add_item(self):
        ...
        for variant, (input_data, expected) in enumerate(
            ...
            with self.subTest(
                ...
                error_msg = (
                    f"Called add_item({input_data[0]}, {input_data[1]}). "
    ...
    def test_read_notes(self):
        ...
        for variant, (input_data, expected) in enumerate(
            ...
            with self.subTest(
                ...
                error_msg = (
                    f"Called read_notes({input_data}). "
                    f"The function returned {actual_result}, but the tests "
    ...
    def test_update_recipes(self):
        input_data = [
            ...
            (
                ...
                (
                    (
                        "Blueberry Pie",
                        {"Blueberries": 2, "Pie Crust": 1, "Cream Custard": 1},
                    ),
                    ("Apple Pie", {"Apple": 1, "Pie Crust": 1, "Cream Custard": 1}),
                ),
            ),
        ...
        for variant, (input_data, expected) in enumerate(
            ...
            with self.subTest(
                ...
                error_msg = (
                    f"Called update_recipes({input_data[0]}, {input_data[1]}). "
                    f"The function returned {actual_result}, but the tests "
    ...
    def test_sort_entries(self):
        ...
        for variant, (input_data, expected) in enumerate(
            ...
            with self.subTest(
                ...
                error_msg = (
                    f"Called sort_entries({input_data}). "
                    f"The function returned {actual_result}, but the tests "
    ...
    def test_send_to_store(self):
        ...
        for variant, (input_data, expected) in enumerate(
            ...
            with self.subTest(
                ...
                error_msg = (
                    f"Called send_to_store({input_data[0]}, {input_data[1]}). "
                    f"The function returned {actual_result}, but the tests "
                    f"expected: {expected} as the fulfilment cart."
                )
    ...
    def test_update_store_inventory(self):
        ...
        for variant, (input_data, expected) in enumerate(
            ...
            with self.subTest(
                ...
                error_msg = (
                    f"Called update_store_inventory({input_data[0]}, {input_data[1]}). "
                    f"The function returned {actual_result}, but the tests "
