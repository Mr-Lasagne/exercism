...
this exercise expects you to use the [raise statement][the-raise-statement] and
"throw" a `ValueError` in your solution if the given value is zero or a negative
integer. The tests will only pass if you both `raise` the `exception` and
