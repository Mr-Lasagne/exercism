...
recipes_with_duplicates = [
    ...
    (
        "Vegan Pizza with Caramelized Onions",
        [
            "mushrooms",
            "rosemary",
            "garlic",
    ...
    (
        "Cheela with Spicy Mango Chutney",
        [
            "clove powder",
            "oil",
            "cinnamon powder",
    ...
    (
        "Sweet and Spicy Crispy Green Beans",
        [
            "soy sauce",
            "pomegranate molasses",
            "sesame oil",
    ...
    (
        "Fried Zucchini with Balsamic and Chili Dressing",
        [
            "honey",
            "lemon juice",
            "garlic",
    ...
    (
        "Cherry Tomato, Watercress and Fava Bean Salad",
        [
            "fresh peas",
    ...
    (
        "Fresh Garden Peas over Cauliflower Almond Puree",
        [
            "red onions",
            "lemon",
            "fresh peas",
    ...
    (
        "Zucchini Fritters with Lemon-Thyme Coconut Yogurt",
        [
            "baking soda",
            "coconut flour",
            "lemon juice",
    ...
    (
        "Roasted Chicken with Roasted Tomatoes, Avocado, and Sweet Potatoes",
        [
            "purple sweet potato",
            "chiles de árbol",
            "garlic",
    ...
    (
        "Chicken with Tamarind and Apricot Sauce",
        [
            "garlic",
            "black pepper",
            "dried apricots",
            ...
            "chipotles",
            "salt",
            "homemade apricot honey preserves",
            "kosher salt",
        ],
    ),
    (
    ...
    (
        "Grilled Pork Chops with Mango Pineapple Salsa",
        [
            "cilantro leaves",
            "lime",
            "pineapple",
    ...
    (
        "Grilled Shrimp and Pesto over Zucchini Noodles",
        [
            "pine nuts",
            "shrimp",
            "green bell pepper",
    ...
    (
        "Cauliflower Pizza with Roasted Tomatoes and Chicken",
        [
            "parmesan",
            "almond meal",
            "rosemary",
    ...
    (
        "Butter Chicken with Grilled Mushrooms, Brussels Sprouts and Mango Chutney",
        [
            "clove powder",
            "curry leaves",
            "coriander seeds",
    ...
    (
        "Parmesan Crackers and Spinach Crackers with Salmon Pate",
        [
            "spinach",
            "parmesan cheese",
            "coconut flour",
    ...
    (
        "Pork Chops with Grilled Castelfranco Radicchio and Asparagus",
        [
            "rosemary",
            "garlic",
            "black pepper",
    ...
    (
        "Burnt Masala Wings with Classic Coleslaw",
        [
            "lime juice",
            "green cabbage",
            "chiles de árbol",
    ...
    (
        "Brisket with Grilled Rhubarb, Onions, and Fennel",
        [
            "white vinegar",
            "parsley",
            "yellow onion",
    ...
    (
        "Roast Leg of Lamb with Crispy Moroccan Carrots & Couscous",
        [
            "oranges",
            "rosemary",
            "garlic",
    ...
    (
        "Lamb over Marinated Summer Squash with Hazelnuts and Ricotta",
        [
            "toasted bread",
            "rosemary",
            "hazelnuts",
...
recipes_without_duplicates = [
    ...
    (
        "georgian_eggplant_rolls_with_walnuts",
        "Georgian Eggplant Rolls with Walnuts",
        {
            "salt",
            "coriander",
    ...
    (
        "burmese_tofu_with_garlic,_ginger_and_chili_sauce",
        "Burmese Tofu with Garlic, Ginger and Chili Sauce",
        {
            "salt",
            "rice vinegar",
    ...
    (
        "vegan_pizza_with_caramelized_onions",
        "Vegan Pizza with Caramelized Onions",
        {
            "red pepper flakes",
            "garlic",
    ...
    (
        "cheela_with_spicy_mango_chutney",
        "Cheela with Spicy Mango Chutney",
        {
            "hing",
            "curry leaves",
    ...
    (
        "sweet_and_spicy_crispy_green_beans",
        "Sweet and Spicy Crispy Green Beans",
        {
            "sesame oil",
            "sriracha",
    ...
    (
        "roasted_corn_and_zucchini_salad",
        "Roasted Corn and Zucchini Salad",
        {
            "zucchini",
            "tomatoes",
    ...
    (
        "white_cheddar_scalloped_potatoes",
        "White Cheddar Scalloped Potatoes",
        {
            "yukon gold potato",
            "shallots",
    ...
    (
        "roast_pumpkin_and_lentil_salad_with_roasted_lemon_dressing",
        "Roast Pumpkin and Lentil Salad with Roasted Lemon Dressing",
        {
            "red wine vinegar",
            "dijon mustard",
    ...
    (
        "cambodian-style_vegetable_spring_rolls",
        "Cambodian-Style Vegetable Spring Rolls",
        {
            "sunflower oil",
            "vegetarian fish sauce",
    ...
    (
        "fried_zucchini_with_balsamic_and_chili_dressing",
        "Fried Zucchini with Balsamic and Chili Dressing",
        {
            "zucchini",
            "balsamic vinegar",
    ...
    (
        "cherry_tomato,_watercress_and_fava_bean_salad",
        "Cherry Tomato, Watercress and Fava Bean Salad",
        {
            "salt",
            "fresh or frozen fava beans",
    ...
    (
        "fresh_garden_peas_over_cauliflower_almond_puree",
        "Fresh Garden Peas over Cauliflower Almond Puree",
        {
            "grated nutmeg",
            "red onions",
    ...
    (
        "walnut_ravioli_with_artichokes_and_tomatoes",
        "Walnut Ravioli with Artichokes and Tomatoes",
        {
            "salt",
            "fresh tomatoes",
    ...
    (
        "zucchini_fritters_with_lemon-thyme_coconut_yogurt",
        "Zucchini Fritters with Lemon-Thyme Coconut Yogurt",
        {
            "salt",
            "coconut oil",
    ...
    (
        "grilled_flank_steak_with_caesar_salad",
        "Grilled Flank Steak with Caesar Salad",
        {
            "flank steak",
            "avocado oil",
    ...
    (
        "roasted_chicken_with_roasted_tomatoes,_avocado,_and_sweet_potatoes",
        "Roasted Chicken with Roasted Tomatoes, Avocado, and Sweet Potatoes",
        {
            "safflower oil",
            "shallots",
    ...
    (
        "grilled_fish_tacos_with_cauliflower_tortillas",
        "Grilled Fish Tacos with Cauliflower Tortillas",
        {
            "salt",
            "eggs",
    ...
    (
        "grilled_pork_chops_with_mango_pineapple_salsa",
        "Grilled Pork Chops with Mango Pineapple Salsa",
        {
            "pork chops",
            "lacinato kale",
    ...
    (
        "grilled_shrimp_and_pesto_over_zucchini_noodles",
        "Grilled Shrimp and Pesto over Zucchini Noodles",
        {
            "salt",
            "green bell pepper",
    ...
    (
        "cauliflower_pizza_with_roasted_tomatoes_and_chicken",
        "Cauliflower Pizza with Roasted Tomatoes and Chicken",
        {
            "roasted chicken",
            "eggs",
    ...
    (
        "flank_steak_with_chimichurri_and_asparagus",
        "Flank Steak with Chimichurri and Asparagus",
        {
            "fresh parsley",
            "salt",
    ...
    (
        "butter_chicken_with_grilled_mushrooms,_brussels_sprouts_and_mango_chutney",
        "Butter Chicken with Grilled Mushrooms, Brussels Sprouts and Mango Chutney",
        {
            "hing",
            "curry leaves",
    ...
    (
        "parmesan_crackers_and_spinach_crackers_with_salmon_pate",
        "Parmesan Crackers and Spinach Crackers with Salmon Pate",
        {
            "fresh cucumber",
            "pecans",
    ...
    (
        "pork_chops_with_grilled_castelfranco_radicchio_and_asparagus",
        "Pork Chops with Grilled Castelfranco Radicchio and Asparagus",
        {
            "pork chops",
            "salt",
    ...
    (
        "seared_salmon_with_pickled_vegetable_and_watercress_salad",
        "Seared Salmon with Pickled Vegetable and Watercress Salad",
        {
            "red wine vinegar",
            "caster sugar",
    ...
    (
        "braised_pork_belly_with_apple_salad",
        "Braised Pork Belly with Apple Salad",
        {
            "spring onions",
            "dark soy sauce",
    ...
    (
        "shrimp,_bacon_and_crispy_chickpea_tacos_with_salsa_de_guacamole",
        "Shrimp, Bacon and Crispy Chickpea Tacos with Salsa de Guacamole",
        {
            "fresh tortillas",
            "slivered almonds",
    ...
    (
        "burnt_masala_wings_with_classic_coleslaw",
        "Burnt Masala Wings with Classic Coleslaw",
        {
            "mayonnaise",
            "carrot",
    ...
    (
        "dahi_puri_with_black_chickpeas",
        "Dahi Puri with Black Chickpeas",
        {
            "roasted chicken",
            "scallion chutney",
    ...
    (
        "brisket_with_grilled_rhubarb,_onions,_and_fennel",
        "Brisket with Grilled Rhubarb, Onions, and Fennel",
        {
            "crushed red pepper flakes",
            "rhubarb",
    ...
    (
        "roast_leg_of_lamb_with_crispy_moroccan_carrots_&_couscous",
        "Roast Leg of Lamb with Crispy Moroccan Carrots & Couscous",
        {
            "bay leaves",
            "fresh thyme",
    ...
    (
        "lamb_over_marinated_summer_squash_with_hazelnuts_and_ricotta",
        "Lamb over Marinated Summer Squash with Hazelnuts and Ricotta",
        {
            "red pepper flakes",
            "hazelnuts",
...
all_drinks = [
    ...
    (
        "Black & Blue Berries",
        ["blackberries", "blueberries", "honey", "lemon juice", "soda water"],
    ),
    (
        "Bloody Mary",
        [
    ...
    (
        "Citrus Fizz",
        ["organic marmalade cordial", "seedlip grove 42", "sparkling water"],
    ),
    ...
    (
        "Huckleberry Shrub",
        ["club soda", "huckleberries", "sugar", "white wine vinegar"],
    ),
    (
        "Mai Tai",
        [
    ...
    (
        ...
        ["almonds", "club soda", "kosher salt", "limes", "ripe raspberries", "sugar"],
    ),
    (
        "Salted Meyer Lemon and Sage Presse",
        ["club soda meyer lemons", "kosher salt", "sage leaves", "simple syrup"],
    ),
    ...
    (
        ...
        [";ime juice", "club soda", "muddled cucumber", "simple syrup"],
    ),
    (
        "Whiskey Sour",
        ["cherry", "lemon juice", "lemon slices", "superfine sugar", "whiskey"],
    ),
]
...
drink_names = [
    ...
    "Banana Punch Mocktail",
    "Beet Sumac Soda Mocktail",
    "Better Than Celery Juice Mocktail",
    "Black & Blue Berries Mocktail",
    "Bloody Mary Cocktail",
    "Bloody Shame Mocktail",
    "Chai Blossom Mocktail",
    "Chile-lime Pineapple Soda Mocktail",
    "Citrus Fizz Mocktail",
    "Dry Martini Cocktail",
    "Espresso Martini Cocktail",
    "Fermented Grape Soda Mocktail",
    "French 75 Cocktail",
    "Gimlet Cocktail",
    "Gin Fizz Cocktail",
    ...
    "Mango Mule Mocktail",
    "Manhattan Cocktail",
    "Maple-Ginger Cider Switchel Mocktail",
    "Margarita Cocktail",
    "Mojito Cocktail",
    "Moscow Mule Cocktail",
    "Negroni Cocktail",
    "Old Fashioned Cocktail",
    "PG13 Singapore Sling Mocktail",
    "Penicillin Cocktail",
    "Pina Colada Cocktail",
    "Raspberry Almond Soda Mocktail",
    "Salted Meyer Lemon and Sage Presse Mocktail",
    "Salted Watermelon Juice Mocktail",
    "Shirley Tonic Mocktail",
    "Shirley ginger Mocktail",
    "Spiced Hibiscus Tea Mocktail",
    "Turmeric Tonic Mocktail",
    "Virgin Cucumber Gimlet Mocktail",
...
dishes_categorized = [
    "Zucchini Fritters with Lemon-Thyme Coconut Yogurt: PALEO",
    ...
    "Butter Chicken with Grilled Mushrooms, Brussels Sprouts and Mango Chutney: KETO",
...
dishes_labeled = [
    ...
    (
        "Brisket with Grilled Rhubarb, Onions, and Fennel",
        {"soy sauce", "garlic", "red onion", "yellow onion"},
    ),
    (
        "Burmese Tofu with Garlic, Ginger and Chili Sauce",
        {"soy sauce", "garlic", "peanuts"},
    ),
    ("Burnt Masala Wings with Classic Coleslaw", {"honey", "butter", "garlic cloves"}),
    (
        "Butter Chicken with Grilled Mushrooms, Brussels Sprouts and Mango Chutney",
        {"heavy cream", "garlic", "butter", "tomatoes"},
    ),
    (
        "Cambodian-Style Vegetable Spring Rolls",
        {"soy sauce", "firm tofu", "garlic", "toasted peanuts"},
    ),
    (
        "Cauliflower Pizza with Roasted Tomatoes and Chicken",
        {"parmesan", "mozzarella cheese", "tomato paste", "cherry tomatoes", "eggs"},
    ),
    ("Dahi Puri with Black Chickpeas", {"red onion", "whole-milk yogurt"}),
    ("Flank Steak with Chimichurri and Asparagus", {"garlic"}),
    (
        "Fried Zucchini with Balsamic and Chili Dressing",
        {"honey", "garlic", "red onion"},
    ),
    (
        "Kingfish Lettuce Cups",
        {"soy sauce", "oyster sauce", "garlic", "grilled king fish"},
    ),
    ("Kisir with Warm Pita", {"bulgur", "tomato paste"}),
    ("Shakshuka", {"tomatoes", "tomato paste", "firm tofu", "yellow onion"}),
    (
        "Shrimp, Bacon and Crispy Chickpea Tacos with Salsa de Guacamole",
        {"shrimp", "garlic", "butter", "slivered almonds", "bacon"},
    ),
...
dishes_and_overlap = [
    (item[0], item[1]) for item in zip(ingredients_only, intersections)
]
