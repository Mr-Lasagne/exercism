...
import pytest
from little_sisters_essay import (
    capitalize_title,
...
class TestLittleSistersEssay(unittest.TestCase):
    @pytest.mark.task(taskno=1)
    def test_capitalize_word(self):
        actual_result = capitalize_title("canopy")
        expected = "Canopy"
        error_message = (
            f'Called capitalize_title("canopy"). '
    ...
    def test_capitalize_title(self):
        ...
        error_message = (
            f'Called capitalize_title("fish are cold blooded"). '
            f'The function returned "{actual_result}", '
            f'but the tests expected "{expected}" for the title.'
        )
    ...
    def test_sentence_ending(self):
        ...
        expected = True
        error_message = (
            f'Called check_sentence_ending("Snails can sleep for 3 years."). '
            f"The function returned {actual_result}, "
    ...
    def test_sentence_ending_without_period(self):
        ...
        expected = False
        error_message = (
            f'Called check_sentence_ending("Fittonia are nice"). '
            f"The function returned {actual_result}, "
            f"but the tests expected {expected} for a period ending."
        )
    ...
    def test_remove_extra_spaces_only_start(self):
        ...
        error_message = (
            f'Called clean_up_spacing("  A rolling stone gathers no moss"). '
            f'The function returned "{actual_result}", '
    ...
    def test_replace_word_choice(self):
        ...
        error_message = (
            'Called replace_word_choice("Animals are cool.", "cool", "awesome"). '
            f'The function returned "{actual_result}", '
    ...
    def test_replace_word_not_exist(self):
        ...
        error_message = (
            'Called replace_word_choice("Animals are cool.", "small", "tiny"). '
            f'The function returned "{actual_result}", '
