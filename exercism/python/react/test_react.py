...
class TestReact(unittest.TestCase):
    ...
    def test_removing_a_callback_multiple_times_does_not_interfere_with_other_callbacks(
        self,
    ):
        input = InputCell(1)
        output = ComputeCell(
    ...
    def test_callbacks_should_not_be_called_if_dependencies_change_but_output_value_does_not_change(
        self,
    ):
        input = InputCell(1)
        plus_one = ComputeCell(
